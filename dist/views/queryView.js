...
exports.QueryViewProvider = void 0;
const vscode = __importStar(require("vscode"));
const webviewUtils_1 = require("./webviewUtils");
class QueryViewProvider {
    constructor(extensionUri, getClient) {
        ...
        webviewView.webview.onDidReceiveMessage(async (msg) => {
            try {
                if (msg?.type === "runQuery") {
                    ...
                    const assets = (0, webviewUtils_1.resolveWebAssetUris)({ webview: this.resultsPanel.webview, extensionUri: this.extensionUri });
                    ...
                    for await (const chunk of client.runQuery(sql, Array.isArray(msg.params) ? msg.params : [])) {
                        ...
                        postToGrid({ type: "queryChunk", id: chunk.id, columns: chunk.columns.map(c => (0, webviewUtils_1.sanitizeHtml)(c)), rows: chunk.rows });
                    }
...
<body>
  ...
  <script nonce="${nonce}" src="${scriptUri}"></script>
    ...
    getReactHtml(webview, assets, codiconUri, nonce) {
...
exports.QueryViewProvider = QueryViewProvider;
QueryViewProvider.viewType = "easyDb.queryView";
